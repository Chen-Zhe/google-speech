 ...
 public:
  ...
  class Stub GRPC_FINAL : public StubInterface {
   public:
    ...
    ::grpc::Status ListLogs(::grpc::ClientContext* context, const ::google::logging::v2::ListLogsRequest& request, ::google::logging::v2::ListLogsResponse* response) GRPC_OVERRIDE;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::google::logging::v2::ListLogsResponse>* AsyncListLogsRaw(::grpc::ClientContext* context, const ::google::logging::v2::ListLogsRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
  ...
  class WithAsyncMethod_ListLogs : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_ListLogs() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListLogs(::grpc::ServerContext* context, const ::google::logging::v2::ListLogsRequest* request, ::google::logging::v2::ListLogsResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithGenericMethod_ListLogs : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_ListLogs() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListLogs(::grpc::ServerContext* context, const ::google::logging::v2::ListLogsRequest* request, ::google::logging::v2::ListLogsResponse* response) GRPC_FINAL GRPC_OVERRIDE {
